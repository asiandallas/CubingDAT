...
// CubingDAT allows for people to save their best times. Most useful with a large group of people such as a cubing compeition. 
int main()
{ 
  cout << "Welcome to CubingDAT. This app is designed to record a user's main speedcubing events and their best single" << endl;  // cout an explanation of what this App should be used for. 
  ...
  cout << endl;
    ...
    case 1:  // Add and indicate slot
      ...
      cout << "What event? ";
      cin >> theevent;
      cout << "What is your best time? ";
      cin >> thetime;
      
      //  Create the element with all the info using the 2nd constructor
      theelement = el_t(thekey, thename, theevent, thetime);
      s = HT.add(theelement);
